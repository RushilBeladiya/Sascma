...
import '../../../subject_screen/pdf_list_screen.dart';
...
class _DashBoardScreenState extends State<DashBoardScreen> {
  ...
  void initState() {
    ...
    print("----------------------${homeController.currentStudent.value.firstName}");
                          ...
                          Column(
                            ...
                            children: [
                              Obx(
                                () => Text(
                                  ("${homeController
                                      .currentStudent.value.firstName} ${homeController
                                      .currentStudent.value.lastName} ${homeController
                                      .currentStudent.value.surName}").toUpperCase(),
                                  style: TextStyle(
                                    fontSize: 15.sp,
                                    color: AppColor.whiteColor,
                                    fontWeight: FontWeight.w600,
